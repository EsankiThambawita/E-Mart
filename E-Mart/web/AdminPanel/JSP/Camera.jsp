...
<%@page import="Controller.AdminEditCameraServlet"%>
<!DOCTYPE html>
<html>
    <head>
...
<body>
        ...
        <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-popup" id="myForm_<%= item.getProductId() %>">
                                <form action="/AdminEditCameraServlet" class="form-container" method="post">
                                    <h1>Edit Camera</h1>
                                    ...
                                    <label for="formFactor_<%= item.getProductId() %>"><b>Form Factor</b></label>
                                    <input type="text" placeholder="Enter form factor" name="formFactor" value="<%= item.getFormFactor() %>" required><br>
            ...
            <div id="addProductModal" class="modal" style="display: none;">
                <div class="modal-content">
                    ...
                    <h2>Add Camera</h2>
                    <form id="addProductForm" method="POST" action="/AdminAddCameraServlet">
                        ...
                        <input type="text" id="formFactor" name="formFactor" required><br>
    ...
    <script src="/AdminPanel/JS/deleteCamera.js"></script>
