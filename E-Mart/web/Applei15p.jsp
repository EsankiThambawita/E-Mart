...
<container class="container">
    ...
    <div class="left-column">
        <img src="Images/ProductCategory&Details/i15p/i15p.png" class="thumbnail" id="ProductImg">

        <div class="small-img-row">
            <div class="small-img-col">
                <img src="Images/ProductCategory&Details/i15p/i15p.png" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="Images/ProductCategory&Details/i15p/1.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="Images/ProductCategory&Details/i15p/2.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="Images/ProductCategory&Details/i15p/3.jpg" width="100%" class="small-img">
            </div>
        </div>
    ...
    <div class="right-column">
        ...
        <p class="description">The iPhone 15 Pro combines cutting-edge technology and stunning design. Featuring a 6.1-inch Super Retina XDR display with ProMotion, it offers vibrant colors and smooth, responsive performance.
