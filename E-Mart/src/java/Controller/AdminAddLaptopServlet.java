 ...
 */
@WebServlet(name = "AdminAddLaptopServlet", urlPatterns = {"/AdminAddLaptopServlet"})
public class AdminAddLaptopServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Call DAO method to add the laptop to the database
        DAO.addLaptop(productId, productName, category, quantity, price, photo1, photo2, photo3, photo4, brand, modelName, productDescription, storageCapacity, cpu, memory);
